...
class DishViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    private val name by lazy { view.findViewById<TextView>(R.id.dish_name) }
    private val subs by lazy { view.findViewById<TextView>(R.id.dish_subs) }
    private val image by lazy { view.findViewById<ImageView>(R.id.dish_image) }
